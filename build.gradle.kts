...
dependencies {
    ...
    // compileOnly("mezz.jei:jei-${project.property("mc_version")}-common-api:${project.property("jei_version")}")
    // compileOnly("mezz.jei:jei-${project.property("mc_version")}-neoforge-api:${project.property("jei_version")}")
    // We add the full version to localRuntime, not runtimeOnly, so that we do not publish a dependency on it
    // localRuntime("mezz.jei:jei-${project.property("mc_version")}-neoforge:${project.property("jei_version")}")

    // Example mod dependency using a mod jar from ./libs with a flat dir repository
    // This maps to ./libs/coolmod-${project.property("mc_version")}-${project.property("coolmod_version")}.jar
    // The group id is ignored when searching -- in this case, it is "blank"
    // implementation("blank:coolmod-${project.property("mc_version")}:${project.property("coolmod_version")}")

    // Example mod dependency using a file as dependency
    // implementation(files("libs/coolmod-${project.property("mc_version")}-${project.property("coolmod_version")}.jar"))
